...
class TestGetProvider:
    ...
    def test_get_jwt_bearer_provider(self):
    ...
    def test_get_roundel_provider(self):
...
class TestJwtBearerProvider:
    ...
    def test_build_jwt_payload(self, auth_config, jwt_config):
    ...
    def test_build_jwt_headers_without_kid(self, jwt_config):
    ...
    def test_build_jwt_headers_with_kid(self, jwt_config):
    ...
    def test_build_token_exchange_data(self, auth_config, jwt_config):
    ...
    def test_build_request_headers(self, auth_config):
...
class TestRoundelJWTProvider:
    ...
    def test_build_jwt_payload_nonce_is_unique(self, auth_config, jwt_config):
    ...
    def test_build_jwt_headers(self, jwt_config):
